{{--
    ...
    좌우 여백은 레퍼런스 실측을 따른다 — 섹션 패딩 48, 글 블록이 안쪽으로 48 더 들어가 96 에서 시작한다.
    1440 에서 96px 이 되도록 clamp 로 감쌌다.
...
<x-layouts.app title="신중수 · Product Manager / Product Designer">
    ...
    <header data-nav
            class="fixed inset-x-0 top-0 z-50 h-[73px] bg-canvas/60 backdrop-blur-[20px] transition-transform duration-300 ease-out motion-reduce:transition-none">
        <div class="flex h-full items-center justify-between px-[clamp(1.5rem,6.67vw,96px)]">
    ...
    <main id="top">
        ...
        <section class="relative flex min-h-dvh flex-col justify-center overflow-hidden">
            ...
            <div class="px-[clamp(1.5rem,6.67vw,96px)]">
            ...
            <div class="absolute inset-x-0 bottom-10 px-[clamp(1.5rem,6.67vw,96px)]">
        ...
        <section data-statement class="relative h-[400vh] bg-statement">
            <div class="sticky top-0 flex h-dvh items-center px-[clamp(1.5rem,3.33vw,48px)] py-[clamp(3rem,8vw,120px)]">
                <p class="max-w-statement px-[clamp(0rem,3.33vw,48px)]
                          text-[clamp(1.75rem,3.2vw,46.08px)] leading-[1.08] tracking-[-0.025em]">
